...
def test_draft_indexes_finds_labels_that_need_review():
    labels = [
        ...
        {"id": "job-003", "labeling_notes": "Imported draft; NEEDS HUMAN REVIEW."},
        {"id": "job-004", "labeling_notes": "Reviewed ambiguous salary with a human."},
    ]

    assert draft_indexes(labels) == [1, 2]
